...
# redirect urls
github_redirect_url = "https://github.com/mohammadwasiq0"
twitter_redirect_url = "https://twitter.com/mohammadwasiq0"
medium_redirect_url = "https://medium.com/@mohammadwasiq0"
...
st.markdown(f'<div class="footer">Made with ❤️ by Mohammad Wasiq<a href="{github_redirect_url}"><img src="{github_url}" width="30" height="30"></a>'
             f'<a href="{twitter_redirect_url}"><img src="{twitter_url}" width="30" height="30"></a>'
             f'<a href="{medium_redirect_url}"><img src="{medium_url}" width="30" height="30"></a> </div>', unsafe_allow_html=True)